...
TextRenderer::TextRenderer(unsigned int width, unsigned int height)
{
	...
	this->textShader = instance->loadShader("text", "text.vs", "text.fs", nullptr);
...
void TextRenderer::load(std::string font, unsigned int fontSize)
{
	...
	{
		std::cout << "ERROR::FREETYPE: Could not intiailize font" << std::endl;
	}
...
{
	this->textShader.use();
	this->textShader.setVector3("textColor", color);
